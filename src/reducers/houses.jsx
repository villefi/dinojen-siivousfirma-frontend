import { SHOW_HOUSE, SHOW_HOUSE_SUCCESS, SHOW_HOUSE_FAILURE, FETCH_HOUSES, FETCH_HOUSES_SUCCESS,
  ...
  ADD_GAME, ADD_GAME_FAILURE, ADD_GAME_SUCCESS, ADD_HOUSE, ADD_HOUSE_SUCCESS, ADD_HOUSE_FAILURE,
...
export default function houses(state = initialState, action) {
  switch (action.type) {
    ...
    case LOG_IN_SUCCESS:  //  username : action.payload.tunnus.username,
      return { ...state, tunnus : action.payload.tunnus, isLoading : false, error : null};
    case LOG_IN_FAILURE:
